...
setTimeout(message => {
  console.log(message)
}, 1500, 'Um segundo e meio se passaram desde que a página foi carregada')
*/
...
setTimeout(logMessage, 1500, 'Um segundo e meio se passaram desde que a página foi carregada')
*/
