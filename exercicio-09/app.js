...
function stringAmount (strCaracter) {
  return strCaracter.length
}
*/
/*
FUNCTION EXPRESSION

const stringAmount = function (strCaracter) {
  return strCaracter.length
}
*/ 
...
const stringAmount = strCaracter => strCaracter.length 

console.log(stringAmount('Irving'))
...
*/
/*
function msgPascoa (strSentence) {
  return strSentence.toLowerCase()
}
*/
/*
const msgPascoa = function (strSentence) {
  return strSentence.toLowerCase()
}
*/
const msgPascoa = strSentence => strSentence.toLowerCase()

console.log(msgPascoa('CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO'))
...
*/
/*
function getIndex (character, string) {
  return string.indexOf(character)
}
*/
/*
const getIndex = function (character, string) {
  return string.indexOf(character)
}
*/

const getIndex = (character = 'I', string = 'Irving') => string.indexOf(character)

console.log(getIndex('a', 'Leila'))
...
*/
/*
function isItemIncluded (item = 5, array = [1, 2, 3]) {
  return array.includes(item)
}
*/
/*
const isItemIncluded = function (item, array) {
  return array.includes(item)
}
*/ 
const isItemIncluded = (item, array) => array.includes(item)

console.log(isItemIncluded(4, [1, 5, 4]))
...
*/
/*
function getConcated (array1, array2) {
  return array1.concat(array2)
}
*/
/*
const getConcated = function (array1, array2) {
  return array1.concat(array2)
}
*/

const getConcated = (array1, array2) => array1.concat(array2)

console.log(getConcated([1, 2], [5, 7, 8]))
...
*/
/*
function lastRemoved (array) {
  array.pop()
  return array
}
*/
/*
const lastRemoved = function (array) {
  array.pop()
  return array
}
*/

const lastRemoved = array => {
  array.pop()
  return array
}

console.log(lastRemoved([1, 5, 10, 25]))
...
const logName = () => console.log('Leila Paim')
...
for (let i = 0; i < numbers.length; i++) {
  console.log(`O ${numbers[i]}º item do array [${numbers.join(', ')}] é ${numbers[i]}.`)
}
*/
...
console.log(getLikesMessage(['Irving','Leila', 'Heitor', 'Letícia', 'Tânia']))
