...
const hrefAttribute = document.querySelector('a')

hrefAttribute.setAttribute('href', 'https://github.com/roger-melo-treinamentos/curso-de-js-roger-melo')
...
console.log(hrefAttribute.getAttribute('href'))
...
hrefAttribute.classList.toggle('link')
