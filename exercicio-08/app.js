...
*/
/*
function plus (value1 = 2, value2 = 2) {
...
*/
/*
const division = function (value1 = 10, value2 = 5) {
  return value1 / value2
}
...
*/
/*
function showConsole (txt = '') {
  for (let i = 1; i < 8; i++) {
    console.log(`Esta é a ${i}ª vez ${txt}.`)
  }
}

showConsole('que eu executo um função')
*/
...
function transformToUpperCase2 (array = []) {
  
  let newArray2 = []

  for (let i = 0; i < array.length; i++) {
    newArray2.push(array[i].toUpperCase())
  }
...
console.log(transformToUpperCase2(millennialWords))
*/
