...
person.introduction = () => {
  ...
  return `Oi. Eu sou ${correctGender} ${name} ${lastName}, tenho ${age} ${agePluralOrSingular}, ${height} ${heightMetersPluralOrSingular} de altura, peso ${weight} quilos e, só hoje, eu já caminhei ${walkedMeters} ${walkedMetersPluralOrSingular}.`
}
