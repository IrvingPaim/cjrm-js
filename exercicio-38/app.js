...
const getUrl = currency => `https://v6.exchangerate-api.com/v6/a075794086a2ebbb018da932/latest/${currency}`
...
const init = async () => {
  const exchangeRate = state.setExchangRate(await fetchExchangeRate(getUrl('USD')))
