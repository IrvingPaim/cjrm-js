...
const getCatInfo = () => {
  ...
  return { name, age, color } // shorthand
}
...
external()
    ...
    const movieOfTheCentury = 'o homem da máscara de ferro'
    ...
    extraInternal = movie => movie.toUpperCase()

    // Function Expression

    //const extraInternal = function (movie) {
    //   return movie.toUpperCase()
    //}

    // Function Declaration - Sofre Hosting (Içamento)

    //function extraInternal (movie) {
    //  return movie.toUpperCase()
    //}

    const h1 = document.querySelector('h1')

    h1.innerText = extraInternal(movieOfTheCentury)

    console.log(extraInternal(movieOfTheCentury))
...
let reversedRandomNumbers = randomNumbers.reverse()

console.log(reversedRandomNumbers)

// *************************************

randomNumbers.reverse()

console.log(randomNumbers) // dupla reversão (abaixo as formas baseiam-se nisso)

// **************************************

const reverseRandomNumbers = []

for (let i = randomNumbers.length - 1; i >= 0; i--) {
  reverseRandomNumbers.push(randomNumbers[i])
}

console.log(reverseRandomNumbers)

// *******************************************

const reverseWhile = []

let i = randomNumbers.length - 1

while (i >= 0) {
  reverseWhile.push(randomNumbers[i])
  i--
}
...
let j = randomNumbers.length - 1

 do {
  reverseWhile2.push(randomNumbers[j])
  j--
} while (j >= 0)


console.log(reverseWhile2)

// ********************************************

const reverseForEach = []

randomNumbers.forEach(number => {
  reverseForEach.push(number)
  return reverseForEach
})

console.log(reverseForEach.reverse())
