...
const OddRandomNumbers = randomNumbers.filter(getOddNumbers)
...
const counterNumbersLessThan501 = (accumulator, crazyNumber) => 
...
const crazyNumberBelow501 = crazyNumbers.reduce(counterNumbersLessThan501, 0)

console.log(crazyNumberBelow501)
...
const sqrtNumbers = numbers.map(number => number ** 2)
