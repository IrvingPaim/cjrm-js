...
que recebeu ${cat.name}, "age", que recebeu ${cat.age}, "color", que recebeu ${cat.color}, 
...
let dog = {
  ...
  age: 5,
  color: 'Branco',
  bestFriends: ['Vegeta', 'Trunks'],
  sound: () => 'AuAuAuuu'
}


const getAgeMessage = (caty, dogy) => `A soma das idades de ${cat.name} e ${dog.name} é ${cat.age + dog.age}.`
...
console.log(objectExemplo('null'))
console.log(objectExemplo('undefined'))
console.log(objectExemplo('object'))
