...
const inputUsername = document.querySelector('#username') // referência do input no HTML
const form = document.querySelector('form')
const button = document.querySelector('button')

const paragraphUsernameFeedback = document.createElement('p') // criação do p no HTML
...
const invalidUsernameInfo = {
  ...
  text: 'O valor deve conter no mínimo 6 caracteres,  com apenas letras maiúsc e/ou minúsc',
...
const showUsernameInfo = event => { // Evento de Listened no input
