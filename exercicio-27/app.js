...
setTimeout(() => {
  console.log('Testando código JavaScript assíncrono')
}, 2000)
...
const totalPrice = prices.reduce(getTotalPrices, 0)
//let totalPrice = 0
//
...
const getAvaliableSpacesMessage = (spaces, booksIn) => {
  ...
  const bookPluralOrSingular = getPluralOrSingular(avaliableSpaces, 'livro', 'livros')
